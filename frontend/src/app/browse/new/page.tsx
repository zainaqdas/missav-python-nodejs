...
export default function LatestPage() {
  ...
  const fetchPage = async (pageNum: number) => {
    ...
    try {
      const browseRes = await fetch(`/api/browse?type=new&page=${pageNum}`);
      if (!browseRes.ok) throw new Error('Failed to fetch latest videos');
    ...
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <span className="text-sm text-gray-300">Latest Releases</span>
        </div>
